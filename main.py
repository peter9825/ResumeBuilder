...
def setup_model():
    ...
    model = genai.GenerativeModel(
        ...
        system_instruction=(
            "Your job is creating professional tech resumes in markdown format based on a personal "
            "description provided to you. Your tone should be professional and cater to jobs in the "
...
def output():
    ...
    try:
        ...
        We’re on a mission to hire the very best and are committed to creating exceptional employee experiences where everyone 
        is respected and has access to equal opportunity. We realize that new ideas can come from everywhere in the organization, 
        and we know the next big idea could be yours!

        Job Description
        As a member of the Managed Services Engineering team, we are looking for an individual who is passionate about designing, 
        developing, and delivering cloud-native applications using DevOps principles. The team operates using Agile principles, 
        planning sprint tasks, and helping each other succeed. We use a wide range of tools and technologies including Python, Go, 
        Terraform, New Relic, Salt, and AI tools in a multi-cloud environment (AWS and Azure). Our team is driven to help customers 
        benefit from the products and services Adobe offers. You will also play a key role in innovating, executing, and bringing bold 
        ideas to life, transforming them into impactful solutions for our customers.

        We are seeking a forward-thinking software engineer with tight-knit collaboration skills who is open about progress on tasks, 
        seeks feedback early, and often, works optimally across organizational boundaries. The successful candidate will love working 
        on a team where you constantly learn, experiment, and iterate quickly.
        ...
        • Develop rapid prototypes of new ideas and concepts and champion team discussions about ways to productize features, 
          implement new technologies and improve products.
        ...
        • Follow DevOps principles, engaging and implementing application lifecycle management - from inception and design, 
          through deployment, operations, and refinement.
        • Demonstrate and apply knowledge of software engineering practices, metrics, quality and testing procedures, process creation, 
          and enablement.
        ...
        • A passion for innovation, strong problem-solving skills, and the ability to implement ideas through rapid experimentation 
          and collaboration with multi-functional teams.
        ...
        Our compensation reflects the cost of labor across several U.S. geographic markets, and we pay differently based on those 
        defined markets. The U.S. pay range for this position is $113,400 -- $206,300 annually. Pay within this range varies by work 
        location and may also depend on job-related knowledge, skills, and experience. Your recruiter can share more about the specific 
        ...
        incentives are in the form of sales commission plans. Non-sales roles starting salaries are expressed as base salary and short-term 
        incentives are in the form of the Annual Incentive Plan (AIP).

        In addition, certain roles may be eligible for long-term incentives in the form of a new hire equity award.

        Adobe will consider qualified applicants with arrest or conviction records for employment in accordance with state and local laws 
        and “fair chance” ordinances.

        Adobe is proud to be an Equal Employment Opportunity and affirmative action employer. We do not discriminate based on gender, 
        race or color, ethnicity or national origin, age, disability, religion, sexual orientation, gender identity or expression, veteran status, 
        or any other applicable characteristics protected by law. Learn more.

        Adobe aims to make Adobe.com accessible to any and all users. If you have a disability or special need that requires accommodation 
        to navigate our website or complete the application process, email accommodations@adobe.com or call (408) 536-3015.

        Adobe values a free and open marketplace for all employees and has policies in place to ensure that we do not enter into illegal agreements 
        with other companies to not recruit or hire each other’s employees."
        """
        personal_description = """
